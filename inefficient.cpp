//This program simulates the classic Knight's Tour problem inefficiently
#include <iostream>
#include <iomanip>
#include <fstream>
#include <math.h>
...
moveType = randomMoveType(myEngine);
...
if (row >= 0 && column >= 0 && row <= 7 && column <= 7 && board[row]
[column] == 0) {
